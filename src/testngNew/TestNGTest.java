...
public class TestNGTest {
	...
	{
		System.out.println("This block of code ececute every time before starting each test");
	}
	@AfterMethod
	public void closingConnection()
	{
		System.out.println("This block of code ececute every time after executing each test");
	}
